...
function screen_Display1(pad, buttonTextSource) {
  ...
  if (pad.Range == padRange.STU300 && pad.CheckSize == checkSize.STU300_Large) {
    ...
    pad.Range == padRange.STU430 &&
    pad.CheckSize == checkSize.STU430_Large
  ) {
  ...
  if (pad.Range == padRange.STU300 && pad.CheckSize == checkSize.STU300_Large) {
    ...
    this.signingText.xPos = this.checkboxObj.xPos + 2 * pad.CheckSize;
    this.signingText.yPos =
      this.checkboxObj.yPos + pad.CheckSize - pad.TextSize;
  } else {
    this.signingText.xPos = this.checkboxObj.xPos + 2 * pad.CheckSize;
  ...
  this.cancelButton = setupCancelButton(
    pad,
    buttonTextSource,
...
function screen_Display3(pad, buttonTextSource) {
  ...
  switch (buttonTextSource) {
    ...
    case textSource.LOCAL:
      ...
      this.okButton.imageFile = setButtonImageFile(
        buttonTextSource,
        pad.Range,
        "Accept"
      );
  ...
  switch (buttonTextSource) {
    ...
    case textSource.LOCAL:
      ...
      this.clearButton.imageFile = setButtonImageFile(
        buttonTextSource,
        pad.Range,
        "Clear"
      );
...
function setupNextButton(pad, buttonTextSource) {
  ...
  switch (buttonTextSource) {
    ...
    case textSource.LOCAL:
      ...
      this.nextButton.imageFile = setButtonImageFile(
        buttonTextSource,
        pad.Range,
        "RightArrow"
      );
...
function setupCancelButton(pad, buttonTextSource, buttonFunc) {
  ...
  switch (buttonTextSource) {
    ...
    case textSource.LOCAL:
      ...
      cancelButton.imageFile = setButtonImageFile(
        buttonTextSource,
        pad.Range,
        imageFilePrefix
      );
...
function setupPreviousButton(pad, buttonTextSource) {
  ...
  switch (buttonTextSource) {
    ...
    case textSource.LOCAL:
      ...
      previousButton.imageFile = setButtonImageFile(
        buttonTextSource,
        pad.Range,
        "LeftArrow"
      );
