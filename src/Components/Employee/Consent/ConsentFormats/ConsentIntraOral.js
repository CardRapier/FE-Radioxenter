...
export default function ConsentIntraOral(props) {
  ...
  return (
    ...
    >
      ...
      <Grid item>
        <Typography variant="body2" style={{ fontWeight: 600 }}>
          TOMA DE RADIOGRAFIAS INTRAORALES: ES UNA DE LAS TECNICAS UTILIZADAS EN
          LA RADIOGRAFIA INTRABUCAL. LA RADIGRAFIA INTRABUCAL ES UNA TECNICA
          EXPLORATORIA CONSISTE EN LA COLOCACION (DENTRO DE LA BOCA) DE PLACAS
          RADIOGRAFICAS DE DIFERENTES TAMANOS QUE SON IMPRESIONADAS, DESDE EL
